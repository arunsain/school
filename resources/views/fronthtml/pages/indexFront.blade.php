...
<div class="row">
	<div id="homeSlider" class="carousel slide" data-ride="carousel">
		...
		<ol class="carousel-indicators">
			@php  $countBanners = 0; @endphp
			  @foreach($banner as $banners)
			<li data-target="#homeSlider" data-slide-to="{{ $countBanners }}" class="@if( $countBanners == 0) active  @endif"></li>
			<!-- <li data-target="#homeSlider" data-slide-to="{{ $countBanners }}"></li>
			<li data-target="#homeSlider" data-slide-to="{{ $countBanners }}"></li> -->
			@php $countBanners++;  @endphp
                    @endforeach
		</ol>
		...
		<div class="carousel-inner" role="listbox">
                  <!--   <div class="item active">
                        <img src="{{ asset('frontcss/assets/img/slider/slide4.jpg') }}" alt="slide1">
                    ...
                    @php  $countBanner = 0; @endphp
                    @foreach($banner as $banners)

                    <div class="item  @if( $countBanner == 0)active  @endif">
                    	<img src="{{ asset('storage/'.$banners->image) }}" alt="slide1">
                    	<div class="carousel-caption">
                    		<h4><i class="fa fa-star-o"></i>{{ $banners->title }}<i class="fa fa-star-o"></i></h4>
                    		<h2><span><i class="fa fa-trophy"></i></span>{{ $banners->short_desc }}</h2>
                    		<p>{{ strip_tags($banners->description) }}</p>
                    		<a href="#"><i class="fa fa-paper-plane"></i>KNOW MORE</a>
                    	</div>
                    </div>

                    @php $countBanner++;  @endphp
                    @endforeach
<!-- 
                    <div class="item">
                        <img src="{{ asset('frontcss/assets/img/slider/slide5.jpg') }}" alt="slide2">
                        <div class="carousel-caption">
							<h4><i class="fa fa-star-o"></i>WE ARE BEST<i class="fa fa-star-o"></i></h4>
					...
					<div class="item">
                        <img src="{{ asset('frontcss/assets/img/slider/slide6.jpg') }}" alt="slide2">
                        <div class="carousel-caption">
                            <h4><i class="fa fa-star-o"></i>WE ARE BEST<i class="fa fa-star-o"></i></h4>
        ...
        <div class="row principal-intro-row">
        	<div class="container">
        		<div class="col-sm-5">
        			<!-- <img src="{{ asset('frontcss/assets/img/principal1.jpg') }}" alt="Our Principal"/> -->
        			<img src="{{ asset('storage/'.$principalData->image) }}" alt="Our Principal"/>
        			<!-- http://localhost:8000/storage/uploads/xDHzmV1ET2nCzcZWANiulW6Pd33Daejp4FxebAFZ.jpeg -->
        		</div>
        ...
        <div class="row section-row evets-row">
        	<div class="container">
        			...
        			<div class="event-tab-link-box">
        				<div class="pull-mid">
        					<ul class="nav nav-tabs">
        						...
        						<li class="<?php if($countevent ==1){ echo 'active'; } ?>">
        							<a  href="#{{ $newsCategorys->id }}" data-toggle="tab"><i class="fa fa-graduation-cap"></i><span>{{ $newsCategorys->category }}</span></a>
        						</li>
        						<!-- <li>								
        							<a href="#2" data-toggle="tab"><i class="fa fa-users"></i><span></span></a>
        						</li>
        						<li>								
        							<a href="#3" data-toggle="tab"><i class="fa fa-trophy"></i><span></span></a>
        						</li> -->
        		...
        		<div class="tab-content">
                     @php $countevents = 1;  @endphp
                     @foreach($newsCategory as $newsCategories)
        			<div class="tab-pane <?php if($countevents ==1){ echo 'active'; } ?>" id="{{ $newsCategories->id }}">
                          
                           

        				<div class="col-md-8 left-event-items">
                             @foreach($newsCategories->limitContent as $fetchContent)
                           @php $dataArrayFetch = json_decode($fetchContent->news_content)  @endphp
        					<div class="event-item">
        						<div class="col-sm-7">
        							<div class="event-date">
        								<p><span>10</span> SEP</p>
        							</div>
        							<h3>{{ $dataArrayFetch->title }}</h3>
        							<h6><i class="fa fa-map-marker"></i> {{ $dataArrayFetch->eventLocation }}<!-- Sciene Building --></h6>
        							<p>  {{ str_limit($dataArrayFetch->description, $limit = 124, $end = '...') }}</p>
        						</div>
        						<div class="col-sm-5 event-item-img">
        							<div class="event-img">
        								<img src="{{ asset('storage/'.$dataArrayFetch->thumbnailEventImage) }}" alt="event" />
        				...
        				<!-- 	<div class="event-item">
        						...
        						<div class="col-sm-5 event-item-img">
        							<div class="event-img">
        								<img src="{{ asset('frontcss/assets/img/news/news-sm2.jpg') }}" alt="event" />
        								<div class="event-detail-link">
        									<a href="#">VIEW DETAILS</a>
        								</div>
        							</div>
 ...
 -->
        				...
        				<div class="col-md-4 right-event-items">
                            @php $sidecount = 1 @endphp
                             @foreach($newsCategories->limitContent as $fetchContents)
                           @php $dataArrayFetchs = json_decode($fetchContents->news_content)  @endphp
                         @if($sidecount == 1)
        					<div class="event-item">
        						<img src="{{ asset('storage/'.$dataArrayFetchs->sideImage) }}" alt="event" />
        					</div>
        					<div class="featured-event">
        						<div class="event-date">
        							<p><span>10</span> SEP</p>
        						</div>
        						<h3>{{ $dataArrayFetchs->title }}</h3>
        						<h6><i class="fa fa-map-marker"></i>{{ $dataArrayFetchs->eventLocation }}</h6>
        						<p>{{ str_limit($dataArrayFetch->description, $limit = 124, $end = '...') }}</p>
        						<a href="#"><i class="fa fa-paper-plane"></i> KNOW MORE</a>
        					</div>
                            @endif
        		...
        		<!-- 	<div class="tab-pane" id="2">
        				<div class="col-md-8 left-event-items">
        					...
        					<div class="event-item">
        						...
        						<div class="col-sm-5 event-item-img">
        							<div class="event-img">
        								<img src="{{ asset('frontcss/assets/img/news/news-sm1.jpg') }}" alt="event" />
        								<div class="event-detail-link">
        									<a href="#">VIEW DETAILS</a>
        								</div>
        							</div>
        				...
        				<div class="col-md-4 right-event-items">
        					<div class="event-item">
        						<img src="{{ asset('frontcss/assets/img/news/news-lg3.jpg') }}" alt="event" />
        					</div>
        					<div class="featured-event">
        						<div class="event-date">
        							<p><span>10</span> SEP</p>
        			...
        			<div class="tab-pane" id="3">
        				<div class="col-md-8 left-event-items">
        					...
        					<div class="event-item">
        						...
        						<div class="col-sm-5 event-item-img">
        							<div class="event-img">
        								<img src="{{ asset('frontcss/assets/img/news/news-sm3.jpg')}}" alt="event" />
        								<div class="event-detail-link">
        									<a href="#">VIEW DETAILS</a>
        								</div>
        							</div>
        ...
        <div class="row section-row teacher-row" style="background-image: url({{ asset('storage/'.$contentdata->firstImage) }});" >
        	<div class="container">
        		<div class="section-row-header-center">
        			<h6><i class="fa fa-star-o"></i>WE ARE BEST<i class="fa fa-star-o"></i></h6>
        		...
        		<div class="owl-carousel" id="ourTeacher">
        			<div class="teacher-item">
        				...
        				<div class="teacher-item-inner">
        					...
        					<div class="col-xs-4 clear-padding teacher-img">
        						<img src="{{ asset('frontcss/assets/img/parent/parent2.jpg')}}" alt="teacher" />
        					</div>
        			...
        			<div class="teacher-item">
        				...
        				<div class="teacher-item-inner">
        					...
        					<div class="col-xs-4 clear-padding teacher-img">
        						<img src="{{ asset('frontcss/assets/img/parent/parent1.jpg') }}" alt="teacher" />
        					</div>
        					<div class="col-xs-8 teacher-details">
        	...
        	<div class="container">
        		...
        		<div class="col-sm-6 col-md-4">
        			<div class="news-item-container">
        				<div class="news-img">
        					<img src="{{ asset('frontcss/assets/img/news/news-sm1.jpg') }}" alt="news"/>
        		...
        		<div class="col-sm-6 col-md-4">
        			<div class="news-item-container">
        				<div class="news-img">
        					<img src="{{ asset('frontcss/assets/img/news/news-sm2.jpg') }}" alt="news"/>
        					<div class="news-item-date">
        		...
        		<div class="col-sm-6 col-md-4">
        			<div class="news-item-container">
        				<div class="news-img">
        					<img src="{{ asset('frontcss/assets/img/news/news-sm3.jpg') }}" alt="news"/>
        					<div class="news-item-date">
        ...
        <div class="row parent-test-row section-row"  style="background-image: url({{ asset('storage/'.$contentdata->secondImage) }});">
        	<div class="container">
        		<div class="section-row-header-center">
        		...
        		<div class="owl-carousel" id="parentTestimonial">
        			<div class="parent-test-item">
        				<div class="col-sm-3">
        					<div class="parent-img">
        						<img src="{{ asset('frontcss/assets/img/parent/parent1.jpg') }}" alt="parent"/>
        					</div>
        				</div>
        				<div class="col-sm-9">
        			...
        			<div class="parent-test-item">
        				<div class="col-sm-3">
        					<div class="parent-img">
        						<img src="{{ asset('frontcss/assets/img/parent/parent2.jpg') }}" alt="parent"/>
        					</div>
        				</div>
        				<div class="col-sm-9">
