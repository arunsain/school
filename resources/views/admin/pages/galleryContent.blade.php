					...
					<div class="row">
						<div class="col-lg-12 clear-padding-xs">		
							<div class="col-md-12">
								...
								@endif
								<form action="{{ route('gallery.update') }}" enctype="multipart/form-data" method="post">
											@csrf
								<div class="dash-item first-dash-item">
									...
									<div class="inner-item">
										<div class="dash-form">
											...
											<div class="col-sm-6">
												<div class="event-img">
											<img style="max-width: 400px;max-height: 265px" src="{{ asset('storage/'.$contentData->galleryImage) }}" alt="event">
												...
												<input type="hidden" name="oldGalleryImage" value="{{ $contentData->galleryImage }}">
