								...
								<div class="dash-item first-dash-item">
									...
									<select required name="className">
										...
										<option>John Doe</option> -->
											...
											<label><i class="fa fa-code"></i>CLASS SECTION</label>
											<select required name="classSection">
								...
								<div class="dash-item first-dash-item">
									...
									<div class="inner-item">
										<table id="attendenceDetailedTable" class="display responsive nowrap" cellspacing="0" width="100%">
											...
											<tbody>
													@foreach($callDetail as $callDetails)
												<tr>
													<td>CLASS {{ $callDetails->class }} - {{ $callDetails->class_section }}</td>
													<td>{{ ucfirst($callDetails->getTeacherData->name) }}</td>
													
													<td>{{ $callDetails->description }}</td>
